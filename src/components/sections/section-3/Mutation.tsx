      ...
      <div className="min-w-0 bg-white p-4 sm:p-6">
        ...
        <div className="grid gap-5">
          <div className="grid gap-2">
            <Label htmlFor="section-3-heading" className="text-sm font-semibold text-slate-800">
              Heading
            </Label>
            <Input
          ...
          <div className="grid gap-2">
            <Label htmlFor="section-3-description" className="text-sm font-semibold text-slate-800">
              Description
            </Label>
            <Textarea
              id="section-3-description"
      ...
      <aside className="border-t border-slate-100 bg-slate-50/70 p-4 sm:p-6 lg:border-l lg:border-t-0">
        <div className="mb-6 flex items-start justify-between gap-3">
          ...
          <Button
            ...
            onClick={() =>
              onChange({ ...formData, paddingX: defaultDataSection3.paddingX, paddingY: defaultDataSection3.paddingY })
            }
          >
