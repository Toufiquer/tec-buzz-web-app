...
import {
  ...
  defaultLayout,
  type Section47Data,
  type Section47Payload,
  type Section47Props,
} from "./data";

const getSectionData = (data?: Section47Data | Section47Payload | string): Section47Payload => {
  if (!data) return { ...defaultDataSection47, ...defaultLayout };

  if (typeof data === "string") {
    try {
      const parsed = JSON.parse(data) as Partial<Section47Payload>;
      return {
        ...defaultDataSection47,
        ...defaultLayout,
        ...parsed,
        paragraphs: parsed.paragraphs || defaultDataSection47.paragraphs,
      };
    } catch {
      return { ...defaultDataSection47, ...defaultLayout };
    }
  }
