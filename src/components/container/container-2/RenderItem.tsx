...
const RenderItem = ({ item, settings, priority = false, loading }: RenderItemProps) => {
  ...
  return (
    <div className="group relative flex h-full w-full min-w-0 flex-col overflow-hidden rounded-sm border border-[#eadfca] bg-white transition duration-500 hover:border-amber-300 hover:shadow-sm">
      {/* Shimmer accent line */}
